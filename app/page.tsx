...
export default async function Home() {
  ...
  return <main>
    ...
    <header className="site-header"><a className="brand" href="/" aria-label="Platinum Benefit Journal home"><span className="brand-mark">PB</span><span><strong>PLATINUM BENEFIT</strong><small>THE JOURNAL</small></span></a><nav aria-label="Main navigation"><a href="#latest">LATEST</a><a href="#guides">PLANNING GUIDES</a><a href="#resources">RESOURCES</a><a href="https://platben.com/">MAIN WEBSITE</a></nav></header>
    <section className="hero"><div className="hero-inner"><p className="eyebrow">THE PLATINUM BENEFIT JOURNAL</p><h1>Knowledge that helps<br/>families move <em>forward.</em></h1><p className="hero-copy">Trusted insights on long-term care, benefits, financial preparation, and the decisions that shape your family’s future.</p><a className="primary-button" href="#latest">READ THE LATEST <ArrowRight size={17}/></a></div><div className="hero-seal" aria-hidden="true"><span>30+</span>YEARS OF<br/>EXPERIENCE</div></section>
    ...
    <footer><a className="brand footer-brand" href="/"><span className="brand-mark">PB</span><span><strong>PLATINUM BENEFIT</strong><small>THE JOURNAL</small></span></a><p>Educational information for families navigating long-term care decisions.</p><p>© {new Date().getFullYear()} Platinum Benefit Services. All rights reserved.</p></footer>
  </main>;
}
